# Zsh configuration as provided by Vim Pro book
# Exports {{{
export GITHUB_USER="eywalker"
export PATH=/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin # Reorder PATH so local bin is first
#export GREP_OPTIONS='--color=auto' # GREP_OPTIONS is deprecated
