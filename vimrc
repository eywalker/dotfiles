...
" List of plugins - needs to be between vundle#begin and vundle#end
...
" Following are sample formtas taken from Vundle's GitHub READM
...
" Ignore case in search unless explicit
set smartcase
...
" Hide the toolbar (for vim with GUI)
set guioptions-=T
...
" Plugin Configs (to be moved elsewhere) {{{
...
"{{{ Gist
" detect the filetype from the file name
let g:gist_detect_filetype = 1
" open created Gist in browser after posting
let g:gist_open_browser_after_post = 1
"}}}
"
"{{{ Git gutter
" Always display the gutter, even when no change present
